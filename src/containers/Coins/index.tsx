...
const Coins = () => {
  ...
  const [{ data, loading }, refecth] = useAxios<CoinDataProps[]>(
    `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&per_page=${queryParams?.per_page || INITIAL_QUERY_PARAMS.per_page
            ...
            return (
              <SC.TableBodyRow key={ele.id}>
                ...
                <SC.TableData>
                  ...
                  <div style={{ color: ColorsEnum.primary }}>
